...
class YamlConfig {
    constructor() {
        ...
        this.keyVaultReferenceIdentityType = UtilModels_1.ManagedIdentityType.SystemAssigned;
        ...
        if (config.keyVaultReferenceIdentity != undefined) {
            this.keyVaultReferenceIdentityType = UtilModels_1.ManagedIdentityType.UserAssigned;
