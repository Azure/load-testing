...
const CoreUtils = __importStar(require("@actions/core"));
class AuthenticationUtils {
    ...
    authorize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.subscriptionName = yield this.getSubName();
            const rg = CoreUtils.getInput(InputConstants.resourceGroup);
            const ltres = CoreUtils.getInput(InputConstants.loadTestResource);
