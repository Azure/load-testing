...
(function (PostTaskParameters) {
    ...
    PostTaskParameters.skipPostProcessing = 'LOADTEST_SKIP_POST_PROCESSING'; // this is set when post-processing (stopping the run) should be skipped, i.e. the run already completed or completion was intentionally skipped.
