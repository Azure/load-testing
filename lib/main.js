...
function getTestAPI(validate) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (testResult.message.statusCode == 200) {
            ...
            var inputScriptFileInfo = testObj.kind == util_2.TestKind.URL ? testObj.inputArtifacts.urlTestConfigFileInfo : testObj.inputArtifacts.testScriptFileInfo;
            if (validate) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (createTestresult.message.statusCode == 201) {
            ...
            if (testFiles.testScriptFileInfo != null) {
                ...
                yield deleteFileAPI(testFiles.testScriptFileInfo.fileName);
            }
...
function uploadTestPlan() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var urlSuffix = "tests/" + testId + "/files/" + filename + "?api-version=" + util.apiConstants.tm;
                ...
                if (testObj && testObj.inputArtifacts && testObj.inputArtifacts.additionalFileInfo) {
                    for (const file of testObj.inputArtifacts.additionalFileInfo) {
                        if (file.fileType == FileType.ZIPPED_ARTIFACTS && (file.validationStatus != "VALIDATION_SUCCESS" && file.validationStatus != "VALIDATION_FAILURE")) {
                            ...
                            zipInvalid = true;
                            zipFailureReason = (_a = file.validationFailureDetails) !== null && _a !== void 0 ? _a : "Validation failed for the zip artifact with an unknown error.";
                            break;
                        }
                    }
                }
...
function getLoadTestResource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield util.httpClientRetries(armEndpoint.toString(), header, 'get', 3, "");
