...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let waitForRunCompletionInput = CoreUtils.getBoolInput(InputConstants.waitForCompletion, true);
            waitForRunCompletionInput && fs.mkdirSync(UtilModels_1.resultFolder); // only make when the wait is true, else folder creation iis un-necessary.
