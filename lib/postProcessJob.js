...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const skipPostProcessing = process.env[UtilModels_1.PostTaskParameters.skipPostProcessing];
            if (!(0, CommonUtils_1.isNullOrUndefined)(runId) && !(0, CommonUtils_1.isNullOrUndefined)(baseUri) && ((0, CommonUtils_1.isNullOrUndefined)(skipPostProcessing) || skipPostProcessing != 'true')) {
