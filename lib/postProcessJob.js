    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!(0, util_1.isNullOrUndefined)(runId) && !(0, util_1.isNullOrUndefined)(baseUri) && ((0, util_1.isNullOrUndefined)(isRunCompleted) || isRunCompleted != 'true')) {
                const yamlConfig = new TaskModels_1.YamlConfig(true);
                const authContext = new AuthenticationUtils_1.AuthenticationUtils();
                const apiSupport = new APISupport_1.APISupport(authContext, yamlConfig);
                yield apiSupport.stopTestRunPostProcess(baseUri, runId);
            }
        }
        catch (err) {
