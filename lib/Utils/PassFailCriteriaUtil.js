...
function validateCriteriaAndConvertToWorkingStringModel(data, failureCriteriaValue) {
    ...
    data.value = data.clientMetric === "requests_per_sec" ? (0, CommonUtils_1.TryExtractLeadingDecimal)(data.value) : (0, CommonUtils_1.TryExtractLeadingInteger)(data.value);
    ...
    let val = data.clientMetric === "requests_per_sec" ? Number(data.value) : parseInt(data.value);
    let currVal = val;
