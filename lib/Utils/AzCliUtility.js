...
exports.getSubscriptions = exports.execAz = void 0;
const child_process_1 = require("child_process");
function execAz(tokenScope) {
...
function runCommand(cmdArguments) {
    return __awaiter(this, void 0, void 0, function* () {
        const azCmd = process.platform === "win32" ? "az.cmd" : "az";
        return new Promise((resolve, reject) => {
            (0, child_process_1.execFile)(azCmd, [...cmdArguments, "--out", "json"], { encoding: "utf8", shell: false }, (error, stdout) => {
                if (error) {
                    return reject(error);
                }
                try {
