...
function addExistingTestParameters(testObj, existingParams) {
    if (!(0, CommonUtils_1.isNullOrUndefined)(testObj.passFailCriteria) && !(0, CommonUtils_1.isNullOrUndefined)(testObj.passFailCriteria.passFailMetrics)) {
        existingParams.passFailCriteria = testObj.passFailCriteria.passFailMetrics;
    }
    if (!(0, CommonUtils_1.isNullOrUndefined)(testObj.passFailCriteria) && !(0, CommonUtils_1.isNullOrUndefined)(testObj.passFailCriteria.passFailServerMetrics)) {
        existingParams.passFailServerMetrics = testObj.passFailCriteria.passFailServerMetrics;
    }
    if (!(0, CommonUtils_1.isNullOrUndefined)(testObj.secrets)) {
        existingParams.secrets = testObj.secrets;
    }
    if (!(0, CommonUtils_1.isNullOrUndefined)(testObj.environmentVariables)) {
...
function getPayloadForServerMetricsConfig(existingServerCriteria, loadTestConfig) {
    ...
    if (!(0, CommonUtils_1.isNullOrUndefined)(existingServerCriteria) && !(0, CommonUtils_1.isNullOrUndefined)(existingServerCriteria.metrics)) {
...
function getAllFileNamesTobeDeleted(loadTestConfig, testFiles) {
    ...
    if (!(0, CommonUtils_1.isNullOrUndefined)(testFiles.additionalFileInfo)) {
    ...
    if (secretRun) {
        try {
            ...
            for (var index in obj) {
                ...
                if ((0, CommonUtils_1.isNullOrUndefined)(val.name)) {
...
function mergePassFailCriteria(loadTestConfig, existingData) {
    ...
    if (!(0, CommonUtils_1.isNullOrUndefined)(loadTestConfig.failureCriteria)) {
...
function mergePassFailServerCriteria(loadTestConfig, existingData) {
    ...
    if (!(0, CommonUtils_1.isNullOrUndefined)(loadTestConfig.serverFailureCriteria)) {
