    ...
    createAndRunTest() {
        return __awaiter(this, arguments, void 0, function* (waitForRunCompletionInput = true) {
            ...
            if (waitForRunCompletionInput) {
                ...
                CoreUtils.exportVariable(UtilModels_1.PostTaskParameters.skipPostProcessing, 'true');
    ...
    */
    ...
    awaitResultsPopulation(testRunId, apiService) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while ((!reportsAvailable || (0, CommonUtils_1.isNullOrUndefined)(vusers)) && count < 30) {
    ...
    printMetrics(testRunObj) {
        ...
        if (!(0, CommonUtils_1.isNullOrUndefined)(testRunObj.passFailCriteria) && !(0, CommonUtils_1.isNullOrUndefined)(testRunObj.passFailCriteria.passFailMetrics))
    ...
    setTaskResults(testRunObj) {
        if (!(0, CommonUtils_1.isNullOrUndefined)(testRunObj.testResult) && Util.isStatusFailed(testRunObj.testResult)) {
            CoreUtils.setFailed("TestResult: " + testRunObj.testResult);
        }
        if (!(0, CommonUtils_1.isNullOrUndefined)(testRunObj.status) && Util.isStatusFailed(testRunObj.status)) {
