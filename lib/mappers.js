...
function getInputParams() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        kind = (_d = config.testType) !== null && _d !== void 0 ? _d : TestKind_1.TestKind.JMX;
        ...
        if (config.configurationFiles != null) {
            ...
            for (let file of tempconfigFiles) {
                if (kind == TestKind_1.TestKind.URL && !util.checkFileType(file, 'csv')) {
        ...
        if (config.zipArtifacts != undefined) {
            ...
            if (kind == TestKind_1.TestKind.URL && tempZipFiles.length > 0) {
        ...
        if (config.properties != undefined && config.properties.userPropertyFile != undefined) {
            if (kind == TestKind_1.TestKind.URL) {
