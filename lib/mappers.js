...
exports.armTokenHeader = armTokenHeader;
...
function getTestRunHeader() {
    return __awaiter(this, void 0, void 0, function* () {
        if (!isExpired()) {
            yield getAccessToken(dataPlaneTokenScope);
        }
        let headers = {
...
function getInputParams() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(pathLib.extname(yamlFile) === ".yaml" ||
        ...
        testId = (_a = config.testId) !== null && _a !== void 0 ? _a : config.testName;
        testId = testId.toLowerCase();
        displayName = (_b = config.displayName) !== null && _b !== void 0 ? _b : testId;
        testdesc = config.description;
        engineInstances = (_c = config.engineInstances) !== null && _c !== void 0 ? _c : 1;
        let path = pathLib.dirname(yamlFile);
        testPlan = pathLib.join(path, config.testPlan);
        kind = (_d = config.testType) !== null && _d !== void 0 ? _d : util_2.TestKind.JMX;
        if (config.configurationFiles != null) {
            let tempconfigFiles = [];
            tempconfigFiles = config.configurationFiles;
            for (let file of tempconfigFiles) {
                if (kind == util_2.TestKind.URL && !util.checkFileType(file, 'csv')) {
        ...
        if (config.zipArtifacts != undefined) {
            ...
            if (kind == util_2.TestKind.URL && tempZipFiles.length > 0) {
        ...
        if (testId === "" ||
            ...
            throw new Error("The required fields testName/testPlan are missing in " + yamlFile + ".");
        }
    });
}
...
function isValidTestKind(value) {
    return Object.values(util_2.TestKind).includes(value);
}
