...
class FeatureFlagService {
    ...
    getFeatureFlagAsync(flag, baseUrl, useCache = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let headers = this.authContext.getDataPlaneHeader(UtilModels_1.CallTypeForDP.get);
            let flagResponse = yield FetchUtil.httpClientRetries(uri, headers, 'get', 3, "", false, false);
            try {
