...
class APIService {
    ...
    patchAppComponents(appComponentsData) {
        return __awaiter(this, void 0, void 0, function* () {
            let urlSuffix = "tests/" + this.testId + "/app-components/" + "?api-version=" + UtilModels_1.ApiVersionConstants.latestVersion;
            let url = new URL(urlSuffix, this.baseURL);
            if (!(0, CommonUtils_1.isNullOrUndefined)(appComponentsData === null || appComponentsData === void 0 ? void 0 : appComponentsData.components) && Object.keys(appComponentsData.components).length == 0) {
                return null;
            }
            let header = yield this.authContext.getDataPlaneHeader(UtilModels_1.FetchCallType.patch);
    ...
    patchServerMetricsConfig(serverMetricsData) {
        return __awaiter(this, void 0, void 0, function* () {
            let urlSuffix = "tests/" + this.testId + "/server-metrics-config/" + "?api-version=" + UtilModels_1.ApiVersionConstants.latestVersion;
            let url = new URL(urlSuffix, this.baseURL);
            if (!(0, CommonUtils_1.isNullOrUndefined)(serverMetricsData === null || serverMetricsData === void 0 ? void 0 : serverMetricsData.metrics) && Object.keys(serverMetricsData.metrics).length == 0) {
                return null;
            }
            let header = yield this.authContext.getDataPlaneHeader(UtilModels_1.FetchCallType.patch);
    ...
    createTestRun(startData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (startTestresult.message.statusCode != 200 && startTestresult.message.statusCode != 201 || (0, CommonUtils_1.isNullOrUndefined)(testRunResp)) {
