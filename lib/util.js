...
exports.ErrorCorrection = exports.getResultObj = exports.validCriteria = exports.isTerminalTestStatus = exports.removeUnits = exports.indexOfFirstDigit = exports.deleteFile = exports.getResultFolder = exports.checkValidityYaml = exports.invalidDescription = exports.invalidDisplayName = exports.invalidName = exports.getUniqueId = exports.sleep = exports.getStatisticsFile = exports.printClientMetrics = exports.getResultsFile = exports.printCriteria = exports.printTestDuration = exports.checkFileType = exports.httpClientRetries = exports.uploadFileData = exports.ManagedIdentityType = exports.apiConstants = exports.TestKind = void 0;
...
function checkValidityYaml(givenYaml) {
    ...
    let kind = (_a = givenYaml.testType) !== null && _a !== void 0 ? _a : TestKind.JMX;
    ...
    if (givenYaml.testType == TestKind.URL) {
    ...
    if (givenYaml.properties != undefined && givenYaml.properties.userPropertyFile != undefined) {
        if ((0, util_1.isNull)(givenYaml.properties.userPropertyFile) || typeof givenYaml.properties.userPropertyFile != 'string' || !checkFileType(givenYaml.properties.userPropertyFile, 'properties')) {
