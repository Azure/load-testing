...
function httpClientRetries(urlSuffix, header, method, retries = 1, content) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (method == 'get') {
                ...
                httpResponse = yield httpClient.request(method, urlSuffix, content, header);
            }
